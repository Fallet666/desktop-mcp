...
- **Linux**: `gnome-screenshot`, `libxtst-dev`, `libpng-dev` (для сборки robotjs)
- **macOS**: права на доступ к экрану (System Preferences → Privacy & Security → Screen Recording)
...
- На Linux скриншоты делаются через `gnome-screenshot`, на macOS — через `screencapture`.
- `robotjs` требует системные библиотеки X11 на Linux для работы с клавиатурой/мышью. На macOS нужны права на доступ к экрану.
